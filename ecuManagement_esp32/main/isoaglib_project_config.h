// IMPORTANT: Never change this header manually, it was generated by the call of "conf2build.sh  ./conf_ecu_management_win32" 
...
#define USE_TIME_GPS
#define USE_ISO_PROPRIETARY_PGN
#define USE_ISO_VIRTUALTERMINAL_CLIENT
#define PRJ_ISO_TERMINAL_OBJECT_SELECTION1 component_vtclient_pool/tutorialManagement-objectselection.inc
#define USE_ISO_FILESERVER_CLIENT
