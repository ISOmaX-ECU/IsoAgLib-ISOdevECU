// IMPORTANT: Never change this header manually, it was generated by the call of "conf2build.sh  ./conf_ecu_display_win32" 
...
#define PRJ_ISO_TERMINAL_OBJECT_SELECTION1 component_vtclient_pool/tutorialDisplay-objectselection.inc
